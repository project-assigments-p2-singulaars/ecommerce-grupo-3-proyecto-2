...
section.innerHTML = `
<section class="section-cardL">
<div class="cardL">
    <div class="product-img-Fav-container">
        <img id="favL" src="../cardsProducts/imgDucksProducts/Favorite1.svg">
        <img class= "front" src= "../cardsProducts/imgDucksProducts/front_london.jpg">
    </div>
    <div class="porductImgViewsContainer">
        <img class= "v1" src="../cardsProducts/imgDucksProducts/v1_london.jpg">
        <img class= "v2" src="../cardsProducts/imgDucksProducts/v2_london.jpg">
        <img class= "v3" src="../cardsProducts/imgDucksProducts/v3_london.jpg">
    </div>
    ...
    <div class="productButtonsContantiner">
        <button class="buttonAddToCard"> Añadir a la cesta <img src="./imgDucksProducts/+ button.svg" alt=""></button>
        <button class="buttonBuyNow"> Comprar Ahorra <img src="./imgDucksProducts/shopping card button.svg" alt=""></button>
    </div>
</div>
</section>
`
